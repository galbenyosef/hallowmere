...
export function createRosterPicker({getState,onChoose,onClose}){
 ...
 dialog.innerHTML=`<header class="roster-header"><div><span class="eyebrow">HALLOWMERE · THE ASHEN VIGIL</span><h2 id="roster-title">Choose your character</h2></div><button class="roster-close" aria-label="Close character selection">×</button></header><div class="roster-layout"><nav class="roster-classes" aria-label="Playable classes"></nav><div class="roster-portrait"><img alt=""><span class="roster-appearance-name"></span></div><section class="roster-description"><p class="eyebrow roster-role"></p><h3 class="roster-name"></h3><p class="roster-story"></p><div class="roster-stats"></div><dl class="roster-equipment"></dl><div class="roster-skills"></div></section></div><footer class="roster-footer"><p class="roster-note" role="status">Change class at any sanctuary. Your equipment and progress travel with you.</p><button class="primary-button roster-confirm">Start game</button></footer>`;
