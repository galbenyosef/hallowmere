...
export class LocalSession {
 constructor({onSnapshot,onWelcome,onStatus,seed}){Object.assign(this,{onSnapshot,onWelcome,onStatus,seed});this.connected=false;this.closed=false;this.pending=[];this.input={x:0,z:0,angle:0};this.seq=0;this.debt=0;this.lastEvent=0;}
 start(){
  if(this.closed||this.connected)return;
  this.world=new World({seed:this.seed});this.id=this.world.join().player.id;this.worldId=this.world.id;this.lastEvent=this.world.eventId;this.connected=true;
