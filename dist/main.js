...
function applySnapshot(snapshot,changed){
 ...
 if(wasDead&&!state.ended||changed){dismissMainMenu();inventoryPreviews.hide();audio.pause(backgrounded,backgrounded);$('modal-shade').hidden=true;modalKind='';paused=false;toggleMapForDeath();player.rotation.z=0;player.position.y=0;}
