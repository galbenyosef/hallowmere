...
export function updateMenuNavigation(root,active,{disabled=false,canChangeCharacter=true}={}){
 for(const button of root.querySelectorAll('[data-menu]')){
  ...
  button.title=button.dataset.menu==='character'&&!canChangeCharacter?'Return to a sanctuary to change character.':'';
 }
}
