...
export function createGameContext({audio,gameSettings,exploration,resourceOrbs,journeyStore,previewMode,reducedMotion,coarse}){
 const ctx={
  ...
  sessionMode:null,assetsReady:false,loadingFailed:false,sessionGeneration:0,mainMenuOpen:false,cavePreviewStarted:false,defaultCharacterRequested:-1,
