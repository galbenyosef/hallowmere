...
export const WIRED_SLOTS=['worldBounds','safeHere','bossType','enemyModelType','cloneModel','groundPing','ringEffect','slash','steelImpact','particles','telegraph','removeObject','cancelAttack','floatText'];
