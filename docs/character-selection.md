...
A new journey begins as the Sorcerer with no selection screen. In single player,
change character at any time from the pause menu's **Change character**, with **C**,
or by clicking the character name; the journey keeps its progression and its entry
in the journeys list shows the current class. In multiplayer the same controls
require a sanctuary. Switching retains quest progress, crowns, equipment
