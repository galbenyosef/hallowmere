...
| T1-1 | 1.1 | sonnet | model-primitives → geralt, nightblade | dist/{geralt,nightblade}-character-model.js + golden tests | T0-7 | changes-requested | codex/primitives-geralt-nightblade-94b5ab29-38bb | 5985 | f2d8dea..5d18b26 | golden tests verified by orchestrator against main originals AND adopted files (2/2 both); geralt 17106→16470 B, nightblade 13986→13269 B; 303/303; follow-up: add `visible` to fingerprint, recompute from originals |
| T1-2 | 1.1 | sonnet | model-primitives → oathkeeper, ranger | dist/{oathkeeper,ranger}-character-model.js + golden tests | T0-7 | changes-requested | codex/primitives-oathkeeper-ranger-6dd19ea9-56aa | 5342 | 605c711..b15419d | goldens verified by orchestrator vs main originals (4/4) and adopted (4/4); oathkeeper 12471→11987 B, ranger 11879→11391 B; 305/305; found Shape.uuid leaking into ExtrudeGeometry.parameters (stripped); follow-up: add `visible` |
| M2 | 1.2 | sonnet | model-kit.js, icon-atlas.js | dist/main.js, 2 new, 5 appearance tests | M1 | todo | — | — | — | |
| T1-3 | 1.2 | sonnet | model-primitives → reaver, predator-model | dist/{reaver-character-model,predator-model}.js + golden tests | T0-7 | running | codex/primitives-reaver-predator-97c91695-d10a | 5832 | — | started early from 0a50a93; told to fingerprint `visible` and strip uuids |
