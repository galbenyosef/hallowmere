...
|---|---|---|---|---|---|---|---|---|---|---|
| P1 | 3.1 | sonnet | pointer rect cache | dist/mouse-targeting.js, tests/mouse-targeting-pick.test.mjs | G2.6 | running | codex/pointer-rect-cache-b12662a3-0faa | 5896 | — | pulled forward (file-disjoint from all M-steps) per user request for more concurrency; node-only proof (≥500-scenario parity vs verbatim pick); browser p95 measured by orchestrator at the batch gate |
