...
| P5 | 3.2 | opus | snapshot + clone | dist/world.js, dist/local-session.js, tests/snapshot-aliasing.test.mjs | G2.6 | running | codex/snapshot-clone-7e1bfefc-0db0 | 5605 | — | opus; pulled forward; aliasing test first (identity walk + mutation immunity + deepStrictEqual vs tests/fixtures/world-ref.js reference copy); perf-smoke before/after |
