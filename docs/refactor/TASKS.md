...
| G2.6 | 2.6 | M11, P6d | blanket 2026-09-15 | c93d989 (P6d), cdac5aa (M11) (+tracker 0d89754) |
| G3 | 3 | P1, P2, P3, P5, P6a, P6b, P6c, P6d, P6e, P8 (P4 deferred, P7 dropped) | blanket 2026-09-15 | landed incrementally with the Phase 1–2 gates; last = d241ee7 (P6a) |
...
| T3-0 | wrap | orchestrator | Wrap-up: dead test import, font-failure retry in the capture harness, closing PERF.md/VISUAL.md | tests/character-integration.test.mjs, scripts/screenshot.mjs, docs/refactor/{PERF,VISUAL}.md | all | merged | codex/wrap-up-778226f2-4941 | 6058 | d26c83a..078e774 → 448a645 | same-conditions perf A/B vs ff9a17f recorded (p95/p99 down 13–25%, p50 within noise); two-client multiplayer check passed on main |
