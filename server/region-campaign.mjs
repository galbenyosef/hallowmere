import {MAPS,PORTALS,CHECKPOINTS,mapFor,sameMap,availablePortal,createRegionProgress} from '../dist/regions.js';
import {distance,hasLineOfSight,pointBlocked} from '../dist/combat.js';
